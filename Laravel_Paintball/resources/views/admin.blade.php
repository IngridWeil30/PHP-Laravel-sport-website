...
@section('content')
    ...
    <div id="container">
        ...
        @endif
            ...
            <br><button type="button" id="addMatch" class="btn btn-primary">Add match</button><br>
            ...
            <div class="form-group">
                {!! Form::label('age', 'Age') !!}
                {!! Form::number('age', 0, ['class' => 'form-control', 'required' => 'required']) !!}
            </div>
            <div class="form-group">
        ...
        <br>
            ...
            <button type="button" id="findTeam" class="btn btn-primary">Find team and manage</button>

            {!! Form::open(['url' => route('findTeam'), 'id' =>'formFindTeam']) !!}
            <br>
            <h2>Find a team</h2>
            <div class="form-group">
                {!! Form::label('name', 'Name') !!}
                {!! Form::select('name', $teams) !!}
            </div>
            <button class="btn btn-success">Find</button>
